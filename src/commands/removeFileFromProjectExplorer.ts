...
/**
 * @brief Command used to remove a file from the current project in the Project Explorer view by selecting a file from a menu
 * @author BakxY
 */
export function getCommand(context: vscode.ExtensionContext): vscode.Disposable {
    return vscode.commands.registerCommand('vhdl-qqs.removeFileFromProjectExplorer', async () => {
